    ...
    <div className="min-h-screen bg-[#eef6f5]">
      ...
      <nav className="sticky top-0 z-50 bg-white border-b border-[#d0e8e4] shadow-sm">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between">
          <Link href="/" className="flex items-center gap-2.5 group">
            ...
            />
            <span
              className="text-[13px] sm:text-[15px] font-black tracking-[0.16em] uppercase"
              style={{
      ...
      >
        ...
        <div className="relative z-10 max-w-4xl mx-auto px-4 sm:px-6 py-10 sm:py-14">
          ...
          <h1 className="text-white font-extrabold text-2xl sm:text-3xl md:text-4xl leading-tight mb-3">
            {title}
          </h1>
          <p className="text-white/55 text-[12px] tracking-widest uppercase font-medium">
            DaktariScribe Pharma Network &nbsp;&middot;&nbsp; Last updated: {lastUpdated}
          </p>
        </div>
      </div>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 py-8 sm:py-12">
        <div className="bg-white rounded-2xl shadow-md shadow-[rgba(0,185,150,0.07)] border border-[#d0e8e4] px-5 sm:px-8 md:px-12 py-8 sm:py-10">
      ...
      {/* ── Footer ── */}
      <div className="max-w-4xl mx-auto px-4 sm:px-6 pb-10 sm:pb-12 text-center">
